// An enum representing the different types of possible tokens.
enum TokenType {
    NUM,
    PLUS,
    MINUS,
...
// A class representing a given token, which contains a type and a lexeme.
class Token{
    TokenType ty;
    String lexeme;
...
// A class representing a linked list of tokens
class TokenList {
    Token elem;
    TokenList rest;
