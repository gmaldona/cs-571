public class App {
    ...
    // Tests the automaton interpreter in
    // "AutomatonImpl.java"
    ...
    // An example of how to combine automata to build a lexer. The specification for this lexer is
    //
    // NUM: [0-9]+
    // WHITE_SPACE: ' '*
    //
    ...
    // Tests the compiler front-end pipeline by running the lexer and parser.
    // Parameters:
